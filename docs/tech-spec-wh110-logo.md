...
| WH110 右手掌 CAD（原版） | STEP | Fusion 360 / SolidWorks | `wuji-hand-baseline/step/right/right_palm_link.STEP` |
| WH110 右手掌 CAD（带 Logo 凸起） | STP | CAD 建模（方案 B 备用） | `wuji-hand-baseline/step/right/right_palm_link_with_logo.stp` |
| Wuji Logo | PNG 4267×4267 | 设计团队 | `hand-usd-optimization/textures/logo/` |
